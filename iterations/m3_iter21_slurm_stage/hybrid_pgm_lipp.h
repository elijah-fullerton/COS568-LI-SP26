...
class HybridPGMLIPP : public Competitor<KeyType, SearchClass> {
 ...
 private:
  ...
  static constexpr size_t kGlobalBloomBits = 1u << 25;
  ...
  bool GlobalBloomMayContain(const KeyType& key) const {
    ...
    const uint64_t hash3 =
        PublishedBucketState::RotateLeft(hash2 * 0x9E3779B97F4A7C15ULL, 7);
    return TestGlobalBloomBit(static_cast<size_t>(hash1) & (kGlobalBloomBits - 1)) &&
           ...
           TestGlobalBloomBit(static_cast<size_t>(hash3) & (kGlobalBloomBits - 1));
  }
  ...
  void SetGlobalBloomBit(const KeyType& key) {
    ...
    SetGlobalBloomBitAt(static_cast<size_t>(hash3) & (kGlobalBloomBits - 1));
  }
