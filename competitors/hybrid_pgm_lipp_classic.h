#ifndef TLI_HYBRID_PGM_LIPP_CLASSIC_H
#define TLI_HYBRID_PGM_LIPP_CLASSIC_H
...
class HybridPGMLIPPClassic : public Competitor<KeyType, SearchClass> {
 public:
  HybridPGMLIPPClassic(const std::vector<int>& params) {}
 ...
 private:
  ...
  size_t ScreenFlushThreshold() const { return 4096; }
...
#endif  // TLI_HYBRID_PGM_LIPP_CLASSIC_H
