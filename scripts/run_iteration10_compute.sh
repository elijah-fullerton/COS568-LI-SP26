...
STAGE_DIR="${STAGE_DIR:-${REPO_ROOT}/iterations/m3_iter10_slurm_stage}"
ARCHIVE_ROOT="${ARCHIVE_ROOT:-${REPO_ROOT}/slurm_runs/m3_iter10}"
SCRATCH_ROOT="${SCRATCH_ROOT:-/scratch/${USER}/m3_iter10_job_${SLURM_JOB_ID}}"
