...
mkdir -p "${SCRATCH_ROOT}/results" "${SCRATCH_ROOT}/logs"
...
cp "${REPO_ROOT}/scripts/analysis_m3_screen.py" \
  "${SCRATCH_ROOT}/workspace/scripts/analysis_m3_screen.py"
