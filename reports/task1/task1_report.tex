...
\begin{table}[H]
    ...
    \small
    \input{generated/throughput_table.tex}
\end{table}
...
\begin{table}[H]
    ...
    \small
    \input{generated/overall_averages_table.tex}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/task1_throughput_overview.pdf}
...
\begin{table}[H]
    ...
    \label{tab:size}
    \small
    \input{generated/size_table.tex}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/task1_index_size_overview.pdf}
